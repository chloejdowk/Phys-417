...
- [Lab 6 Report: German-to-English Translation with Attention-Mechanism Transformer Model](<>)
- [Lab 7 Report: Agentic Signal versus Background Classification for Exotic Higgs Decays](<>)
- [**Final Project: EEG Emotion Classification**](<>)
...
** Eventually, this work was presented at the class symposium as a [poster presentation](<>)
